...
/*int comojogar(){
    ...
    ALLEGRO_DISPLAY* janela = al_create_display(800, 600);//Cria o display em que ser� mostrado como jogar
    ...
    bool redraw = true;
     ...
     while (1)
     {
         ...
         if (redraw && al_is_event_queue_empty(events))
         {
             ...
             al_draw_text(texto, al_map_rgb(255,255,255),400, 340, ALLEGRO_ALIGN_CENTRE,"Se voce acertar com perfei��o se ganha quinze pontos");
